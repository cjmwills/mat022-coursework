...
The name and data type of each variable can be found in the [Appendix]. They can broadly be split into three groups;
...
```{r fig.width=4, fig.show='hold', fig.cap="Quantile-Quantile plot to test for normality of data."}
