...
**continue here to discuss why extra dataset was brought in and the limitations of it ie different number of observations, different time frames, only medalists included. Then introduce the t-test, what it is used for, and why we are using it here.**
